...
-->
    <xsl:template match="sqf:fix[sqf:call-fix]">
        <xsl:param name="es:xml-base" tunnel="yes" select="base-uri()"/>
        <xsl:copy copy-namespaces="no">
            ...
            <xsl:variable name="content" as="node()*">
                <xsl:apply-templates select="sqf:call-fix" mode="parameter">
                    <xsl:with-param name="es:xml-base" select="base-uri()" tunnel="yes"/>
                </xsl:apply-templates>
                <xsl:apply-templates select="node() except sqf:description" mode="callFix">
                    <xsl:with-param name="es:xml-base" select="base-uri()" tunnel="yes"/>
                </xsl:apply-templates>
            </xsl:variable>
            ...
            <xsl:apply-templates select="$selfDescriptions" mode="callFix"/>
