...
<es:escali-reports xmlns="http://www.w3.org/1999/xhtml" xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns:sqf="http://www.schematron-quickfix.com/validator/process" xmlns:es="http://www.escali.schematron-quickfix.com/">
    <es:meta activePatterns="" phase="phase1" queryBinding="xslt2" schema="file:/D:/nico/Work/Java/net.sqf.tester/data/schematron/sch-tests/test15/in/schema.sch" instance="file:/D:/nico/Work/Java/net.sqf.tester/data/schematron/sch-tests/test15/in/instance.xml">
        <es:title/>
    ...
    <es:pattern>
        <es:meta id="pattern1" phases="phase1 #ALL">
            <es:title>ignore element assert</es:title>
        </es:meta>
        <es:rule>
            <es:meta context="element" id="d3e8"/>
            <es:report location="/*:root[namespace-uri()=''][1]/*:element[namespace-uri()=''][1]" id="d2e4_d3e14" role="0.375" test="@attribute='value'">
