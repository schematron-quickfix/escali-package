...
<es:escali-reports xmlns="http://www.w3.org/1999/xhtml" xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns:sqf="http://www.schematron-quickfix.com/validator/process" xmlns:es="http://www.escali.schematron-quickfix.com/">
    <es:meta activePatterns="" phase="phase1" title="Extends test" queryBinding="xslt2" schema="file:/D:/nico/Work/Java/net.sqf.tester/data/schematron/sch-tests/test6/in/extends.sch" instance="file:/D:/nico/Work/Java/net.sqf.tester/data/schematron/sch-tests/test6/in/extends.xml">
    ...
    <es:pattern>
        ...
        <es:rule>
            <es:meta context="arc:tier[@fleischfresser='nein']">
                <let xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:svrl="http://purl.oclc.org/dsdl/svrl" name="minGewicht" value="arc:gewicht div 10"/>
            </es:meta>
        </es:rule>
        <es:rule>
            <es:meta context="arc:tier[@fleischfresser='nein']">
