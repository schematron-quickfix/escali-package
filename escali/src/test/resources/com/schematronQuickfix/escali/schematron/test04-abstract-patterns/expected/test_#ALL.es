...
<es:escali-reports xmlns="http://www.w3.org/1999/xhtml" xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns:sqf="http://www.schematron-quickfix.com/validator/process" xmlns:es="http://www.escali.schematron-quickfix.com/">
    <es:meta activePatterns="" title="Schematron unit test" phase="#ALL" queryBinding="xslt2" schema="file:/D:/nico/Work/Java/net.sqf.tester/data/schematron/sch-tests/test4/in/test4.sch" instance="file:/D:/nico/Work/Java/net.sqf.tester/data/schematron/sch-tests/test4/in/test4.xml">
    ...
    <es:pattern>
        <es:meta id="pattern5" is-a="pattern6" phases="#ALL">
            <let xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:svrl="http://purl.oclc.org/dsdl/svrl" name="testa2" value="6"/>
        </es:meta>
        <es:rule>
            <es:meta context="pattern6"/>
            <es:assert location="/*:root[namespace-uri()=''][1]/*:pattern6[namespace-uri()=''][1]" test="false()">
                <es:text>Test 6</es:text>
            </es:assert>
        </es:rule>
    </es:pattern>
</es:escali-reports>
