...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2" xmlns:sqf="http://www.schematron-quickfix.com/validator/process" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/1999/xhtml">
    <sch:ns uri="http://www.w3.org/1999/xhtml" prefix="html"/>
    <sch:pattern>
        <sch:rule context="html:body">
            <sch:let name="firstDescendantHeading" value="descendant::node()[name()=('h1','h2','h3','h4','h5','h6')][1]"/>
            <sch:assert test="$firstDescendantHeading/self::html:h1" sqf:fix="setH1 add2bodyH1 addPrecH1 delete">The first headline of a HTML document has to be of level 1.</sch:assert>
            <sqf:fix id="setH1">
                <sqf:description>
            ...
            <sqf:fix id="add2bodyH1">
                ...
                <sqf:user-entry name="h1" type="xs:string" default="/html:html/html:head/html:title">
                    <sqf:description>
            ...
            <sqf:fix id="delete" use-when="($firstDescendantHeading/following::node()[matches(name(),'h[123456]')])[1]/self::html:h1">
                <sqf:description>
        ...
        <sch:rule context="html:h3">
            <sch:let name="firstPrecedingHeading" value="preceding::node()[name()=('h1','h2','h3','h4','h5','h6')][1]"/>
            <sch:report test="$firstPrecedingHeading/self::html:h1" sqf:fix="setH1ToH2 setH3ToH2 addH2beforeH3 addH2afterH1 delete">A headline on level 2 is missing: A &lt;h3&gt; should not follow on a <sch:name path="$firstPrecedingHeading"/>.</sch:report>
            <sqf:fix id="delete" use-when="not((following::node()[matches(name(),'h[123456]')])[1]/self::html:h4)">
                <sqf:description>
            ...
            <sqf:fix id="setH3ToH2" use-when="not((following::node()[matches(name(),'h[123456]')])[1]/self::html:h4)">
                <sqf:description>
        ...
        <sch:rule context="html:h4">
            <sch:let name="firstPrecedingHeading" value="preceding::node()[name()=('h1','h2','h3','h4','h5','h6')][1]"/>
            <sch:report test="$firstPrecedingHeading/self::html:h1" sqf:fix="add2 delete setH4ToH2">The headlines on level 2 and 3 are missing: A &lt;h4&gt; should not follow a &lt;<sch:name path="$firstPrecedingHeading"/>&gt;.</sch:report>
            <sch:report test="$firstPrecedingHeading/self::html:h2" sqf:fix="add delete setH4ToH3">The headline on level 3 is missing: A &lt;h4&gt; should not follow a &lt;<sch:name path="$firstPrecedingHeading"/>&gt;.</sch:report>
            <sqf:fix id="add">
                <sqf:description>
            ...
            <sqf:fix id="add2">
                <sqf:description>
                    <sqf:title>Add a &lt;h2&gt; and a &lt;h3&gt; before the &lt;h4&gt;.</sqf:title>
                </sqf:description>
                <sqf:user-entry name="h2" type="xs:string">
                    <sqf:description>
            ...
            <sqf:fix id="setH4ToH2" use-when="not((following::node()[matches(name(),'h[123456]')])[1]/(self::html:h4|self::html:h5))">
                <sqf:description>
            ...
            <sqf:fix id="setH4ToH3" use-when="not((following::node()[matches(name(),'h[123456]')])[1]/self::html:h5)">
                <sqf:description>
            ...
            <sqf:fix id="delete" use-when="not((following::node()[matches(name(),'h[123456]')])[1]/(self::html:h4|self::html:h5))">
                <sqf:description>
