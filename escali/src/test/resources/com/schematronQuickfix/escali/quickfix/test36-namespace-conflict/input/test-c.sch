...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns:sqf="http://www.schematron-quickfix.com/validator/process" xmlns:es="http://www.escali.schematron-quickfix.com/" queryBinding="xslt2" xmlns="www.some.other.namespace.com">
    <sch:ns uri="www.some.default.namespace.com" prefix="def"/>
    <sch:pattern>
        <sch:rule context="def:elementToReplace">
            <sch:assert test="false()" sqf:fix="replaceDefault replaceNull replaceOther">Bad namespace!</sch:assert>
