...
<es:escali-reports xmlns:es="http://www.escali.schematron-quickfix.com/"
    ...
    <es:meta activePatterns="pattern1"
        ...
        phase="#ALL"
        schema=""
        title="Schematron unit test - node creation node-type comment">
        <es:title>Schematron unit test - node creation node-type comment</es:title>
    ...
    <es:pattern>
        ...
        <es:rule>
            ...
            <es:assert id="w41aab1_w20aab3b1b1"
                ...
                <sqf:fix fixId="addComment" title="Add comment" id="addComment_w41aab1_w20aab3b1b1">
                    <sqf:call-fix ref="addComment"/>
                </sqf:fix>
            </es:assert>
        </es:rule>
    </es:pattern>
