...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:es="http://www.escali.schematron-quickfix.com/" queryBinding="xslt2" defaultPhase="phase1">
    <title>Schematron unit test</title>
    <phase id="phase1">
        <active pattern="pattern1"/>
        <es:phase ref="importPhase"/>
    </phase>
    <pattern id="pattern1">
