...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2"
    xmlns:sqf="http://www.schematron-quickfix.com/validator/process" xmlns:es="http://www.escali.schematron-quickfix.com/" xmlns="foo.com">
    ...
    <sch:pattern id="pattern1">
        <sch:rule context="root">
            ...
            <sqf:fix id="replaceFoo">
                ...
                <sqf:replace match="foo" node-type="element" target="bar" select="'bar-content'"/>
            </sqf:fix>
        </sch:rule>
    </sch:pattern>
</sch:schema>