...
<es:escali-reports xmlns:es="http://www.escali.schematron-quickfix.com/"
    ...
    <es:meta activePatterns="pattern1"
        ...
        phase="#ALL"
        schema=""
        title="Schematron unit test - node creation position after">
        <es:title>Schematron unit test - node creation position after</es:title>
    ...
    <es:pattern>
        ...
        <es:rule>
            <es:meta context="foo" id="w20aab3b1" roleLabel="error">
                <sqf:fix id="addBaz">
                    <sqf:add target="baz" node-type="element" select="'baz-content'" position="after"/>
                </sqf:fix>
            </es:meta>
            <es:assert id="w41aab1_w20aab3b1b1"
                ...
                <sqf:fix fixId="addBaz" title="Add baz after" id="addBaz_w41aab1_w20aab3b1b1">
