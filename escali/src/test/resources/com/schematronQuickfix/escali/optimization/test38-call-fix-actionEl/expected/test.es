...
<es:escali-reports xmlns:es="http://www.escali.schematron-quickfix.com/"
    ...
    <es:meta activePatterns="pattern1"
        ...
        phase="#ALL"
        schema=""
        title="Schematron unit test - call-fix with action element">
        <es:title>Schematron unit test - call-fix with action element</es:title>
        ...
        <es:rule>
            <es:meta context="foo" id="w20aab3b1" roleLabel="error">
                <sqf:fix id="replaceFoo">
                    <sqf:add position="before" node-type="comment" select="'Replaced by bar'"/>
