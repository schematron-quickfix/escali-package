...
<es:escali-reports xmlns:es="http://www.escali.schematron-quickfix.com/"
    ...
    <es:meta activePatterns="pattern1"
        ...
        phase="#ALL"
        schema=""
        title="Schematron unit test - sch:ns in XPath"
        queryBinding="xslt2">
        <es:title>Schematron unit test - sch:ns in XPath</es:title>
    ...
    <es:pattern>
        ...
        <es:rule>
            ...
            <es:report id="w41aab1_w20aab3b1b1"
                ...
                <sqf:fix fixId="deleteBar" title="Delete bar" id="deleteBar_w41aab1_w20aab3b1b1">
                    <sqf:call-fix ref="deleteBar"/>
                </sqf:fix>
            </es:report>
        </es:rule>
    </es:pattern>
