...
<es:escali-reports xmlns:es="http://www.escali.schematron-quickfix.com/"
    ...
    <es:meta activePatterns="pattern1"
        ...
        phase="#ALL"
        schema=""
        title="Schematron unit test - call-fix with multiple calls">
        <es:title>Schematron unit test - call-fix with multiple calls</es:title>
    ...
    <es:pattern>
        ...
        <es:rule>
            ...
            <es:assert id="w41aab1_w20aab3b1b1"
                ...
                <sqf:fix fixId="addChilds" title="Add childs bar and baz" id="addChilds_w41aab1_w20aab3b1b1">
